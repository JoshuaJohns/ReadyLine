...
export default function UserDetails() {
    ...
    return <div className="userDetails-container">
        <div className="userDetails-subContainer">
            ...
            <Card inverse className="userDetails-userInfo-Card">
                <CardImg
                    alt="Card image cap"
                ...
                />
                <CardImgOverlay className="userDetails-cardOverlay">
                    ...
                    />
                    <CardBody className="userDetails-userCardBody">
                        <CardText className="userDetails-userLi">{user.firstName} {user.lastName}</CardText>
                        <CardText className="userDetails-userLi">{user.email}</CardText>
                        <CardText className="userDetails-userLi">{user.jobTitle}---{user?.userType?.name}</CardText>
                        <CardText className="userDetails-userLi"></CardText>
                        <CardText className="userDetails-userLi"></CardText>
                        <h3>Vehicle(s)...</h3>
                        {user?.vehicles?.map((vehicle) => {
                            return <>
                                <li key={vehicle.id}><Link to={`/vehicle`}>{vehicle?.vehicleType?.name} -- {vehicle.vehicleNumber} </Link></li>
                            </>
                        })}
                    </CardBody>
                </CardImgOverlay>
